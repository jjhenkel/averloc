...
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $3 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/ReplaceTrueFalse/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $4 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/RenameFields/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $5 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/RenameParameters/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $6 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/WrapTryCatch/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $7 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/InsertPrintStatements/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $8 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/UnrollWhiles/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $9 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/AddDeadCode/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/gradient-targeting/test.tsv" | awk -F'\t' '{ print $10 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/RenameLocalVariables/gradient/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $3 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/ReplaceTrueFalse/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $4 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/RenameFields/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $5 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/RenameParameters/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $6 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/WrapTryCatch/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $7 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/InsertPrintStatements/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $8 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/UnrollWhiles/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $9 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/AddDeadCode/random/test.tsv"
cat "${DIR}/../datasets/adversarial/test-depth-1-attack/tokens/c2s/java-small/random-targeting/test.tsv" | awk -F'\t' '{ print $10 "\t" $2 }' > "${DIR}/../datasets/single-attacks-tokens/RenameLocalVariables/random/test.tsv"
...
CHECKPOINT=Best_F1 ARGS='--no-attack' MODELS_IN=final-models/seq2seq/c2s/java-small/normal DATASET_NAME=datasets/single-attacks-tokens/AddDeadCode/gradient RESULTS_OUT=final-results/individual-attacks/c2s-java/normal-model/AddDeadCode/gradient time make test-model-seq2seq
CHECKPOINT=Best_F1 ARGS='--no-attack' MODELS_IN=final-models/seq2seq/c2s/java-small/normal DATASET_NAME=datasets/single-attacks-tokens/AddDeadCode/random RESULTS_OUT=final-results/individual-attacks/c2s-java/normal-model/AddDeadCode/random time make test-model-seq2seq
